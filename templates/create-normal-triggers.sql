...
CREATE TRIGGER "fkc_{{ name(foreignSchema, foreignTable) }}_insert"
...
CREATE TRIGGER "fkc_{{ name(foreignSchema, foreignTable) }}_delete"
...
CREATE TRIGGER "fkc_{{ name(foreignSchema, foreignTable) }}_update"
